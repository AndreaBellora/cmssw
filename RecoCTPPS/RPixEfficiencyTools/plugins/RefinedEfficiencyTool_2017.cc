...
// Class:      RefinedEfficiencyTool_2017
//
/**\class RefinedEfficiencyTool_2017 RefinedEfficiencyTool_2017.cc
 RecoCTPPS/RPixEfficiencyTools/plugins/RefinedEfficiencyTool_2017.cc
...
public:
  explicit RefinedEfficiencyTool_2017(const edm::ParameterSet &);
  ~RefinedEfficiencyTool_2017();
...
RefinedEfficiencyTool_2017::RefinedEfficiencyTool_2017(
...
void RefinedEfficiencyTool_2017::analyze(const edm::Event &iEvent,
...
void RefinedEfficiencyTool_2017::fillDescriptions(
...
void RefinedEfficiencyTool_2017::beginJob() {
...
void RefinedEfficiencyTool_2017::endJob() {
...
void RefinedEfficiencyTool_2017::getPlaneCombinations(
    const std::vector<uint32_t> &inputPlaneList, uint32_t numberToExtract,
    std::vector<std::pair<std::vector<uint32_t>, std::vector<uint32_t>>>
        &planesExtractedAndNot) {
...
float RefinedEfficiencyTool_2017::probabilityCalculation(
...
float RefinedEfficiencyTool_2017::probabilityNplanesBlind(
...
bool RefinedEfficiencyTool_2017::Cut(CTPPSPixelLocalTrack track, int arm,
                                     int station) {
  double maxTx = 0.02;
  double maxTy = 0.02;
  double maxChi2 = TMath::ChisquareQuantile(0.95, track.getNDF());
...
DEFINE_FWK_MODULE(RefinedEfficiencyTool_2017);