...
static constexpr auto s_tag = "[EfficiencyTool_2018]";

TEST_CASE("Standard checks of EfficiencyTool_2018", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("EfficiencyTool_2018"
