...
void UsefulCommandsSt2{
	...
	int arm = 0;
	h2TrackHitDistribution_arm0_st2_rp3_0->Fit("amplitudeFitFunction2","N","",44.3,fitRanges[std::pair<int,int>(arm,station)].at(1));
	...
	arm = 1
	h2TrackHitDistribution_arm1_st2_rp3_0->Fit("amplitudeFitFunction2","N","",44.3,fitRanges[std::pair<int,int>(arm,station)].at(1));
	amplitudeFitFunction2->SetParameters(0,0,0);
