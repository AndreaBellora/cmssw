...
then
	...
	then	
		...
		# addJSON=" useJsonFile=true jsonFileName=/eos/project-c/ctpps/Operations/DataExternalConditions/2017/combined_RPIN_CMS_Era${1}_45IN.json" #special json
	...
	# eval "cmsRun python/RefinedEfficiencyAnalysis_cfg.py sourceFileList=InputFiles/EraB${fileSuffix}.dat efficiencyFileName=OutputFiles/Era${1}${fileSuffix}.root outputFileName=OutputFiles/Era${1}_refinedEfficiency${fileSuffix}.root ${addJSON_B}"
	...
	# eval "cmsRun python/EfficiencyVsXi_cfg.py era=${1} sourceFileList=InputFiles/EraB${fileSuffix}.dat efficiencyFileName=OutputFiles/Era${1}_interpotEfficiency${fileSuffix}.root outputFileName=OutputFiles/Era${1}_efficiencyVsXi_fromMultiRP_XiSingle${fileSuffix}.root useMultiRPEfficiency=True ${addJSON_B}"
	set +x
fi