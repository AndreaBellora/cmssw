...
then
	...
	eval "cmsRun python/EfficiencyAnalysis_cfg.py sourceFileList=InputFiles/${nameTag}.dat outputFileName=OutputFiles/${nameTag}.root runNumber=${1} bunchSelection=NoSelection"
fi