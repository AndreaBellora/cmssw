...
then
	...
	eval "cmsRun python/RefinedEfficiencyAnalysis_cfg.py sourceFileList=InputFiles/EraB.dat efficiencyFileName=OutputFiles/Era${1}${fileSuffix}.root outputFileName=OutputFiles/Era${1}_refinedEfficiency${fileSuffix}.root"
	...
	eval "cmsRun python/EfficiencyVsXi_cfg.py era=${1} sourceFileList=InputFiles/EraB.dat efficiencyFileName=OutputFiles/Era${1}_refinedEfficiency${fileSuffix}.root outputFileName=OutputFiles/Era${1}_efficiencyVsXi${fileSuffix}.root"
	eval "cmsRun python/EfficiencyVsXi_cfg.py era=${1} sourceFileList=InputFiles/EraB.dat efficiencyFileName=OutputFiles/Era${1}_refinedEfficiency${fileSuffix}.root outputFileName=OutputFiles/Era${1}_efficiencyVsXi${fileSuffix}_useMultiRPProtons.root useMultiRPProtons=True"
