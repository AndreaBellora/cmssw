...
then
	...
	echo ""
	echo "***Cleaning Up***"
	echo "Removing /eos/project/c/ctpps/subsystems/Pixel/RPixTracking/EfficiencyCalculation2018/ReRecoOutputTmp_CMSSW_10_6_0_pre3/Run${1}.root and its link"
	eval "rm /eos/project/c/ctpps/subsystems/Pixel/RPixTracking/EfficiencyCalculation2018/ReRecoOutputTmp_CMSSW_10_6_0_pre3/Run${1}.root ReReco/OutputFiles/Run${1}.root"
