...
then
	...
	do
		...
		eval 'echo "executable			= $CMSSW_BASE/src/RecoCTPPS/RPixEfficiencyTools/ReReco.sh"							>> test/Jobs/${nameTag}_${i}.sub'
	...
	condor_submit_dag -notification Always "test/Jobs/${nameTag}.dag" 
