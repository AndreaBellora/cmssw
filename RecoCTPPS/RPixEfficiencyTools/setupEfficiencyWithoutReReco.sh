...
then
	...
	eval "ln -s /eos/project/c/ctpps/subsystems/Pixel/RPixTracking/EfficiencyCalculation2017/ReRecoOutputTmp/Run${1}.root test/OutputFiles/Run${1}.root"
	echo "***Creating JSON file***"
	jsonline=`eval "sed -n -e 's/^.*${1}/\"${1}/p' /eos/project/c/ctpps/Operations/DataExternalConditions/2017/combined_RPIN_CMS.json"` 
