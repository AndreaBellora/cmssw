...
void ViewPlots(Int_t RunNumber, bool noVideoOutput = false){
	...
	Int_t firstRunOfTheYear = 297000;
	Int_t lastRunPreTs1     = 298000;
	Int_t lastRunPreTs2     = 303000;
	Int_t lastRunOfTheYear  = 307000;

	Int_t yAlignmentRun 	= 297050;
	...
	if (RunNumber < firstRunOfTheYear){
		cout << "This run doesn't belong to 2017 data taking!" << endl;
		// return;
	}
	...
	if(TS1_TS2){ 
		...
		shift = {{0,0},{2,0}};
		yAlignmentRun = 297050;
	}
	if(Post_TS2){ 
		shift = {{0,0},{2,10}};
		// shift = {{0,0},{2,0}};
		yAlignmentRun = 303832;
	}
	...
	// vector<float> areaForControlEfficiency_arm1_st0{15.,0.,8.};
	...
	TFile* fitFile = new TFile(Form("OutputFiles/EraB.root"), "READ");
